...
def CNN(input_shape=(100,120,1), classes=49): 
    ...
    # 20，12，32 → 6，6，64
    X = Conv2D(filters=2, kernel_size=(5,5), strides=(2,2),padding='same',activation='relu', name='conv2')(X)
    X = MaxPooling2D((2,2), strides=(2,2), name='pool2')(X)
    
    # 6，6，64 → 3，3，128
    X = Conv2D(filters=2, kernel_size=(3,3), strides=(1,1),padding='same',activation='relu', name='conv3')(X)
